        ...
        <div class="flex items-center justify-center w-full space-x-[14px]">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                    ...
                    xml:space="preserve" width="22" height="22" fill="white" class="h-[20px] md:h-[22px]">
                    <g id="WA_Logo">
                        <g>
            ...
            <div class="<?= esc( $titleClass ?? 'roboto-bold tracking-wide text-[16px] text-white' ) ?>">
                <?= esc( $title ?? 'Hubungi Kami' ) ?></div>
        </div>
    </button>
</a>