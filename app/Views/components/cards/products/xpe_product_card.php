<div class="flex justify-center sm:justify-start items-center pt-[150px] px-[20px] sm:px-0 animate-top-product-card">
    <div class="relative max-w-[420px] p-[20px] h-full bg-[#0D55C8] rounded-[25px] shadow-[2px_4px_4px_0px_rgba(0,0,0,0.2)]">
        <div class="absolute flex justify-center h-[200px] w-full top-0 left-0 -translate-y-[82%] sm:-translate-y-[82%] lg:-translate-y-[82%] ">
            <img loading="lazy" src="https://cdn.jsdelivr.net/gh/okakakikioAxe/kpn-storage/tp-xpe-product.webp" alt="produk xpe" class="absolute w-[80%] sm:w-[100%] lg:w-[80%] max-w-[320px] h-auto mx-auto">
            <img loading="lazy" src="https://cdn.jsdelivr.net/gh/okakakikioAxe/kpn-storage/tp-xpe-shadow.webp" alt="shadow produk xpe" class="absolute  w-[80%] sm:w-[100%] lg:w-[80%] max-w-[320px] h-auto mx-auto">
        </div>
        <div class="flex flex-col h-full">
            <div class="flex-none mt-[10px] w-full">
                <h3 class="mt-[85px] min-h-[50px] place-content-end font-trebuchet text-white text-[36px] sm:text-[28px] md:text-[36px] text-start font-[400]" data-lang-group="homepage_top_product" data-lang-key="product_title_4">PRODUK XPE</h3>
                <p class="mt-[24px] sm:h-[250px] md:h-[210px] lg:h-[180px] 2xl:h-[240px] font-humanist-normal text-white text-[16px] text-start font-[400]" data-lang-group="homepage_top_product" data-lang-key="product_description_4">
