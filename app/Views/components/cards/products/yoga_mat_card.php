<div id="yogaMatCard" class="flex justify-center sm:justify-start items-center pt-[150px] px-[20px] sm:px-0 animate-top-product-card">
    <div class="relative max-w-[420px] p-[20px] h-full bg-[#0D55C8] rounded-[25px] shadow-[2px_4px_4px_0px_rgba(0,0,0,0.2)] lg:cursor-pointer lg:ease-in-out lg:transition-transform lg:duration-300 lg:hover:scale-110">
        ...
        <div class="absolute flex justify-center h-[200px] w-full top-0 left-0 -translate-y-[70%] ">
            <img src="images/yoga/varian-5.webp" alt="eva mat" class="absolute w-[80%] max-w-[220px] h-auto right-5    ">
            <img src="images/yoga/shadow-yoga.png" alt="shadow eva mat" class="absolute  w-[80%] max-w-[220px] h-auto right-5">
        </div>
        <div class="absolute flex justify-center h-[200px] w-full top-0 right-0 -translate-y-[80%] rotate-y-180">
            <img src="images/yoga/yoga.webp" alt="eva mat motif" class="absolute scale-110 w-[80%] max-w-[250px] h-auto right-3 ">
            <img src="images/yoga/shadow-yoga.png" alt="shadow eva mat" class="absolute  scale-110 w-[80%] max-w-[250px] h-auto right-3">
        </div>
        <div class="flex flex-col h-full">
            <div class="flex-none mt-[65px] w-full">
                <div class=" flex">
                    <p class="font-trebuchet text-orange-300 text-[22px] sm:text-[18px] text-start font-[400]">3+ Varian Model</p>
                </div>
            </div>
...
<div id="yogaMatModal" class="fixed z-10 inset-0 items-center hidden justify-center bg-black/70 opacity-100 backdrop-blur-0  transition-opacity duration-300">
    <div id="yogaMatModalContent" class=" bg-royal-azure p-[60px] w-[1200px] h-[670px] rounded-[40px] transform scale-95 opacity-100 transition-transform duration-300">
        <button id="closeYogaMatModalBtn" class="absolute top-[20px] right-[18px] w-[38px] h-[38px] bg-white rounded-full hover:bg-white/80 cursor-pointer transition-transform duration-200 ease-in-out transform-gpu hover:scale-105 flex justify-center items-center">
        ...
        <div class="absolute flex justify-end h-[263px] w-full top-0 right-[64px] -translate-y-[70%]">
            <img id="yogaMatDynamicImage" src="images/kubus apung/kubus-apung-biru.png" alt="kubus apung HDPE" class="absolute w-auto h-[263px] mx-auto border-white">
