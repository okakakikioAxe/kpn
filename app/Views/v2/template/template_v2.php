...
<head>
  ...
  })(window, document, 'script', 'dataLayer', 'GTM-PVVPQ2GQ');
  </script>
  ...
  <!-- Google tag (gtag.js) -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-17276630748">
  </script>
  <script>
  ...
  <link rel="icon" type="image/png" sizes="64x64" href="/kpn-logo.png">
...
<body class="bg-white">
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PVVPQ2GQ" height="0" width="0"
  ...
  <nav id="main-navbar" class="transition-all duration-300 transform fixed top-0 left-0 w-screen z-99 text-white  ">
          ...
          <li class="relative group">
            ...
            <ul
              ...
              <div id="desktop-product-dropdown" class="mt-[30px] bg-black/40 rounded">
                ...
                <li>
                  <a href="<?= esc($product_link ?? '/product') ?>" class="block px-4 py-2 rounded hover:bg-gray-100 ">
                    <?= 
        ...
        <div class="relative inline-block text-left dropdown ">
          <div id="dropdown-selected" class="cursor-pointer nav-link ">
            <div class="flex w-full h-full items-center space-x-9">
              ...
              <span class="nav-link px-[21px] language-button">
                Bahasa Indonesia
              </span>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px"
                y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="32"
                height="32" fill="white" class="w-[25px] h-[25px] mr-[21px]" id="navbar-language-icon">
                <g>
                  <g>
            ...
            <div class="dropdown-content absolute hidden w-full z-10 pt-3">
              <div class="bg-white rounded-md w-auto text-gray-800 text-[16px]">
                <div class="px-[21px] py-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='id'>
                  Bahasa Indonesia
                </div>
                <div class="px-[21px] py-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='en'>
                  English</div>
                <div class="px-[21px] py-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='cn'>
                  普通话</div>
              </div>
            </div>
          </div>
    ...
    <div id="mobile-menu"
      ...
      <ul
        ...
        <li class="relative">
          <div id="mobile-product-trigger" class="flex justify-between items-center w-full nav-link cursor-pointer">
            <span class="text-[18px] text-gray-700 roboto-bold"><?= esc($product_link_title ?? 'Produk') ?></span>
          ...
          <ul id="mobile-product-dropdown" class="hidden flex-col space-y-1 pl-4 mt-2 ubuntu-regular text-[16px]">
            <li>
              <a href="<?= esc($product_link ?? '/product') ?>" class="block px-4 py-1 rounded hover:bg-gray-100">
                <?= 
                                    (strpos($_SERVER['REQUEST_URI'], '/en/') !== false) 
                                        ? 'All Products'
                                        : ((strpos($_SERVER['REQUEST_URI'], '/cn/') !== false) 
        ...
        <div id="navbar-language-border-mobile"
          ...
          <div class="relative inline-block text-left dropdown ">
            <div id="dropdown-selected-mobile" class="nav-link px-[21px] ">
              <div class="flex w-full h-full items-center space-x-9">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px"
                  ...
                  width="32" height="32" class="fill-gray-700" class="w-[25px] h-[25px]"
            ...
            <div id="dropdown-content-mobile" class="hidden absolute top-[32px] w-full z-100 pt-3 ">
              <div class="bg-white w-auto text-gray-700 text-[16px] border-1 border-gray-300 rounded-[10px]">
                <div class="p-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='id'>Bahasa
                  Indonesia</div>
                <div class="p-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='en'>English
                </div>
                <div class="p-2 rounded-md cursor-pointer hover:bg-gray-100 language-option" data-lang='cn'>普通话</div>
              </div>
            </div>
            <!-- Custom dropdown trigger -->
          </div>
  ...
  <div id="waButton" class="z-80 sticky bottom-[45px] h-0 w-full flex justify-end items-end">
    ...
    <div class="mr-[20px] flex flex-col items-end">

      <!-- Bubble -->
      <div
        class="relative mb-3 bg-white text-gray-800 font-semibold text-sm px-4 py-2 rounded-xl shadow-xl border border-gray-100 whitespace-nowrap animate-pulse">
        Hubungi Kami
        <!-- Panah Bubble -->
        <span class="absolute -bottom-2 right-6 w-4 h-4 bg-white border-r border-b border-gray-100 rotate-45"></span>
      </div>

      <!-- Tombol WA -->
      <a href="https://api.whatsapp.com/send?phone=6282160050005&text=Halo%20saya%20butuh%20info">
        <div
          class="h-[60px] lg:h-[70px] aspect-square rounded-full bg-green-500 shadow-xl hover:scale-110 transition-all duration-300 flex items-center justify-center cursor-pointer">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" class="w-[30px] lg:w-[35px] h-auto">
            <path
