...
<body class="bg-white">
    ...
    <nav id="main-navbar" class="transition-all duration-300 transform fixed top-0 left-0 w-screen z-99 text-white">
        ...
        <div id="desktop-navbar"
            class="hidden xl:flex max-w-[1200px] mx-auto py-[20px] items-center justify-between relative z-20">
    ...
    <section id="footer-section">
        <div
            ...
            <div
                class="grid grid-cols-1 sm:grid-cols-10 md:grid-cols-10 gap-x-10 gap-y-10 w-full h-full max-w-[1200px] relative mb-[20px]">
