...
<section id="product-section" class="w-full relative z-10 pt-[126px] mb-[200px]">
    ...
    <div class="space-y-4">
        ...
        <div class="accordion-item">
            <!-- HEADER OPEN -->
            <div class="flex items-start gap-4 cursor-pointer py-4 border-b" data-accordion-header>

                <!-- LEFT ICON BOX -->
                <div class="w-12 h-12 bg-red-100 rounded-lg"></div>
                ...
                <div class="flex items-center gap-2 text-sm">
                    <span>16+</span>
                    <span class="transition-transform duration-300" data-arrow>›</span>
                </div>
            </div>

            <!-- CONTENT GRID (Extended) -->
            <div class="grid grid-cols-5 gap-4 pt-4 hidden" data-accordion-content>

                <div class="w-full pb-[100%] bg-gray-300 rounded-lg"></div>
                <div class="w-full pb-[100%] bg-gray-300 rounded-lg"></div>
                <div class="w-full pb-[100%] bg-gray-300 rounded-lg"></div>
                <div class="w-full pb-[100%] bg-gray-300 rounded-lg"></div>
                <div class="w-full pb-[100%] bg-gray-300 rounded-lg"></div>
    ...
    <script>
        document.querySelectorAll('.accordion-item').forEach(item => {
            ...
            header.addEventListener('click', () => {
                ...
                document.querySelectorAll('[data-accordion-content]').forEach(c => c.classList.add(
                    'hidden'));
