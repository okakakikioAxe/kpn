...
<meta name="description"
    content="Jelajahi galeri PT Karya Pilar Nusantara (PT KPN) dan temukan foto produk, koleksi terbaru dan perjalanan kami." />
<meta name="keywords"
    content="galeri KPN, foto produk KPN, gambar produk HDPE, gambar produk EVA, gambar produk TPE, gambar produk XPE, portofolio PT KPN, koleksi produk KPN" />
    ...
    <div id="hero-text" class="w-full flex items-center justify-center mx-auto px-4 py-8 text-white text-center">
        <div class="flex flex-col w-full h-full items-center justify-center relative z-10  my-[150px]">
            ...
            <p
                ...
                jangan lewatkan informasi terbaru dari kami. Temukan inspirasi lewat kegiatan yang kami bagikan.
            </p>
            <button
                ...
                <div class="flex items-center justify-center w-full space-x-[14px]">
                    ...
                    <div class="roboto-bold tracking-wide text-[16px] sm:text-[18px] text-white">Jelajahi Galeri</div>
                </div>
            </button>
        </div>
    </div>
        ...
        <div id="bottomSection"
            ...
            <div class="relative h-[100%] pb-[20px] px-6 w-full ">
                ...
                <p id="modalDesc"
                    ...
                    to solve the problem. But I would like to state that using/implementing an http handler is not a
                    part of the required solution. The solution is that you have to put necessary headers to the
                    response like below Just for the simplification of the mentioned solution on above link, they have
                    used an http handler to solve the problem. But I would like to state that using/implementing an http
                    handler is not a part of the required solution. The solution is that you have to put necessary
                    headers to the response like below Just for the simplification of the mentioned solution on above
                    link, they have used an http handler to solve the problem. But I would like to state that
                    using/implementing an http handler is not a part of the required solution. The solution is that you
                    have to put necessary headers to the response like below Just for the simplification of the
                    mentioned solution on above link, they have used an http handler to solve the problem. But I would
                    like to state that using/implementing an http handler is not a part of the required solution. The
                    solution is that you have to put necessary headers to the response like below</p>
