...
<?= $this->section('header') ?>
<html lang="id">
<title>PT. Karya Pilar Nusantara - Perusahaan Pengadaan Produk</title>
<meta name="description"
    content="PT Karya Pilar Nusantara (KPN) adalah perusahaan pengadaan barang yang menyediakan berbagai macam produk berkualitas tinggi, mulai dari mainan playground indoor, berbagai jenis matras, hingga perlengkapan kebutuhan perairan seperti kubus apung, kincir air, toren, palet, dan masih banyak lagi." />
<meta name="keywords"
...
<section id="overview-section"
    ...
    <div id="overview-mobile-content" class="sm:hidden">
        ...
        <div class="flex w-full items-center justify-center">
            ...
            <div id="image-container-mobile" class="md:hidden w-screen aspect-square relative">
                <?= view('components/texts/title/title_group', ['id' => 'overview-title-default','class' => 'block w-full mb-[60px] text-center', 'top_title' => 'Menghadirkan Nilai,', 'bottom_title' => 'Bukan Sekadar Barang']) ?>
                <div class="w-full">
                    <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div class="swiper-wrapper" id="swiper-wrapper-3109a1ff4ed3f18c1" aria-live="polite"
                            ...
                            <div class="swiper-slide flex justify-center swiper-slide-active"
                                ...
                                <div class=" shadow overflow-hidden flex items-center justify-center">
                                    <div class="w-full mx-10 ">
                                        <img src="/images/overview/overview1.jpeg"
                                            class="w-full h-2/3 object-cover rounded-3xl aspect-square">
                            ...
                            <div class="swiper-slide flex justify-center swiper-slide-next" data-swiper-slide-index="1"
                                ...
                                <div class=" shadow overflow-hidden flex items-center justify-center">
                                    <div class="w-full mx-10 ">
                                        <img src="/images/overview/overview2.jpg"
                                            class="w-full h-2/3 object-cover rounded-3xl aspect-square">
                            ...
                            <div class="swiper-slide flex justify-center" data-swiper-slide-index="2" role="group"
                                ...
                                <div class=" shadow overflow-hidden flex items-center justify-center">
                                    <div class="w-full mx-10 ">
                                        <img src="/images/overview/overview3.jpeg"
                                            class="w-full h-2/3 object-cover rounded-3xl aspect-square">
                                    </div>
                                </div>
                            </div>
    ...
    <div id="overview-desktop-content" class="hidden sm:block px-15">
        <?= view('components/texts/title/title_group', ['id' => 'overview-title-sm','class' => 'flex flex-col w-full items-center justify-center mb-[80px] lg:hidden', 'top_title' => 'Menghadirkan Nilai,', 'bottom_title' => 'Bukan Sekadar Barang']) ?>
            ...
            <div class="flex w-full items-center justify-center">
                <div id="image-container"
                    ...
                    <img id="img1" alt="BKKBN 1"
                        ...
                        src="/images/overview/overview1.jpeg" width="455" height="455">
                    <img id="img2" alt="Light green square with rounded corners"
                        ...
                        src="/images/overview/overview2.jpg" width="455" height="455">
                    <img id="img3" alt="Light green square with rounded corners"
                        ...
                        src="/images/overview/overview3.jpeg" width="455" height="455">
                </div>
            </div>
            <div class="flex items-center md:items-start flex-col justify-center px-5 sm:px-8 md:px-10">
                <?= view('components/texts/title/title_group', ['id' => 'overview-title-lg','class' => 'hidden lg:block', 'top_title' => 'Menghadirkan Nilai,', 'bottom_title' => 'Bukan Sekadar Barang']) ?>
                <p
    ...
    <div class="w-full flex items-center justify-center bg-white relative">
        ...
        <div id="service-section-mobile" class="lg:hidden">
            <div class="w-full max-w-[1400px] my-[150px] z-20 relative px-10 md:px-15 ">
                <?= view('components/texts/title/title_group', ['id' => 'service-title','class' => 'block w-full mb-[60px] md:mb-[90px] text-center sm:hidden', 'top_title' => 'Kami Memberikan', 'bottom_title' => 'Yang Terbaik']) ?>
                <?= view('components/texts/title/title_group', ['id' => 'service-title-sm','class' => 'hidden sm:block text-center w-full sm:mb-[90px] items-start justify-center', 'top_title' => 'Kami Memberikan', 'bottom_title' => 'Yang Terbaik Untuk Anda']) ?>
