  ...
  <div class=" w-[600px] lg:w-full max-w-[1200px] ">
    ...
    <div class="mt-[46px]">
      ...
      <div class="mb-0  border-b-[#DEDEDE] border-b-[1.5px]">
        ...
        <div class="faq-content text-gray-600">
          <p class="pb-[40px] font-humanist-normal text-[16px] md:text-[18px] lg:text-[20px]" data-lang-group="contact_us_faq" data-lang-key="answer_4">Tentu, silakan hubungi tim marketing kami untuk mendapatkan penawaran terbaik. Hubungi kami melalui WhatsApp di +62 821-6005-0005 atau email pt.karyapilarnusantara@gmail.com.</p>
        </div>
      </div>
    </div>
  </div>
