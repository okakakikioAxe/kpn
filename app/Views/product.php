...
<section id="heroSection" class="relative h-screen w-full bg-white">
  ...
  <div class="absolute inset-0 flex flex-col items-center justify-center px-[40px] md:px-[10%]">
    ...
    <a href="#" class="flex mt-[30px] md:mt-[34px] xl:mt-[40px] bg-[#00AD5E] font-trebuchet text-[18px] w-[230px] h-[43px] text-white font-bold rounded-full shadow-lg items-center justify-center hover:bg-[#13ba45] hover:scale-105 transform duration-300 ease-in-out">
      Jelajahi Produk
    </a>
  </div>
</section>
