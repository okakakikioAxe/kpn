    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="p-6 flex-1 overflow-y-auto">
                <form id="upload-form" action="/admin/galery/update/<?= $content['id'] ?>" method="PUT"
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                                ...
                                <div
                                    ...
                                    <div class="text-center">
                                        <div id="preview-container" class="mt-4 flex justify-center">
                                            ...
                                            <video id="video-preview" src="/galery/content/<?= $content['image'] ?>"
                                                class="max-h-[800px] relative w-full h-full object-contain"
                                                controls></video>
                                            <?php else: ?>
                                            <img id="image-preview" src="/galery/content/<?= $content['image'] ?>"
                                                class="mt-2 max-h-[800px] relative w-full h-full object-contain rounded-lg shadow-lg" />
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <div
                                            ...
                                            <input required type="text" name="title" value="<?= $content['title'] ?>"
                                                id="title"
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea required name="description" value="<?= $content['description'] ?>"
                                            id="description" rows="3"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                            placeholder="Deskripsi konten"><?= $content['description'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
