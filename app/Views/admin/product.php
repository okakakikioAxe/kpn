                ...
                <div>
                    <div class="relative inline-block text-left mr-4">
                        <button id="dropdownButton1"
                            class="px-5 py-[2.5px] w-auto text-white rounded-lg border-[1px] border-white bg-gray-400  cursor-pointer">
                            ...
                            <div class="w-full max-w-[1600px] flex justify-end sm:mx-[25px] ">
                                <div id="dropdownMenu1"
                                    ...
                                    <button onclick="filter('all')"
                                        class="block px-4 py-3 text-white hover:bg-gray-200 text-start w-full cursor-pointer">Semua
                                        Kategori</button>
                                    <button onclick="filter('hdpe')"
                                        class="block px-4 py-3 text-white hover:bg-gray-200 text-start w-full cursor-pointer">HDPE</button>
                                    <button onclick="filter('xpe')"
                                        class="block px-4 py-3 text-white hover:bg-gray-200 text-start w-full cursor-pointer">XPE</button>
                                    <button onclick="filter('eva')"
                                        class="block px-4 py-3 text-white hover:bg-gray-200 text-start w-full cursor-pointer">EVA</button>
                                    <button onclick="filter('toy')"
                                        class="block px-4 py-3 text-white hover:bg-gray-200 text-start w-full cursor-pointer">MAINAN</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="product-detail-container" class="w-full justify-center hidden bg-white">
                    <div class="flex flex-col w-full max-w-[1200px]">
                        <div class="flex w-full max-w-[1200px]">
                            ...
                            <div class="flex flex-col w-1/2 justify-start items-start p-10">
                                <div class="relative w-full">
                                    <div
                                        class="absolute top-0 right-0 h-20 z-10 flex justify-end items-center -translate-y-15">
                                        <button onclick="closeProductDetail()"
                                            class="px-4 py-2 text-gray-600 hover:bg-gray-100 cursor-pointer">X</button>
                                    </div>
                                </div>
                                <h3 id="product-detail-title"
                                    class=" text-stone-800 text-[26px] font-trebuchet leading-[135%] font-bold"></h3>
                                <div id="product-detail-category"
                                    class="mt-1 px-2 py-1 border-2 rounded-4xl font-humanist-normal text-[14px] tracking-wider font-bold text-white">
                                </div>
                                <div id="product-detail-variant-container" class="w-full mt-6">
                                    <div class="flex">
                                        <p class="mr-[4px] text-stone-500 text-[16px] font-[500]">Varian :</p>
                                        <p id="product-detail-variant-title"
                                            class="mb-1 text-stone-800 text-[16px] font-humanist-normal font-bold">-</p>
                                    </div>
                                    <div id="variant-select-container" class="w-full grid grid-cols-none"
                                        style="grid-template-columns: repeat(auto-fill, minmax(30px, 1fr)); gap: 4px;">
                                    </div>
                                </div>
                                <div id="product-detail-description"
                                    class="mt-7 text-stone-800 text-[18px] font-humanist-normal">
                        ...
                        <div class="flex w-full justify-end space-x-2 mb-6">
                            <button id="editBtn"
                                class="py-2 px-4 rounded-lg bg-orange-400 text-white hover:bg-orange-500 cursor-pointer">Edit</button>
                            <button id="deleteBtn"
                                class="py-2 px-4 rounded-lg bg-red-400 text-white hover:bg-red-600 cursor-pointer">Hapus</button>
                        </div>
                    </div>
                </div>
