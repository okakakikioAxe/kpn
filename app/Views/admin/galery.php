...
=======
                    <li class="py-2"><a href="/admin/galery"
                            class="block px-4 py-2 hover:bg-gray-700 bg-gray-700 rounded">Gallery</a></li>
                    <li class="py-2"><a href="/admin/product" class="block px-4 py-2 hover:bg-gray-700">Produk</a></li>
...
>>>>>>> b3e526899119848feddc0ba1691280352cade722
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="header sticky top-0 z-5 bg-white shadow-md flex justify-between items-center p-6">
                ...
                <a href="/admin/galery/create" type="button"
            ...
            <main class="p-6 flex-1 overflow-y-auto">
                ...
                <div id="imageModal"
                    class="fixed z-10 top-0 left-0 w-full pt-16 h-[100vh] hidden items-center justify-center bg-black/70 opacity-100 backdrop-blur-0 transition-opacity duration-300 ease-in-out">
                    ...
                    <div id="imageContent"
                        ...
                        <button id="closeModal"
                            class=" absolute z-15 top-3 right-3 text-gray-500 hover:text-gray-700 cursor-pointer">
                            ✖
                        </button>

                        <div id="topSection"
                            class="h-[75%] sm:h-full w-full sm:w-[50%] sm:py-6 bg-black flex items-center justify-center sm:rounded-l-lg">
                            <img id="modalImage" loading="lazy" src=""
                                class="relative w-full h-full object-contain hidden">
                            <video loading="lazy" id="modalVideo" src="" controls preload="auto"
                                class="relative w-full h-full object-contain hidden" type="video/mp4"></video>
                        </div>
                        <div id="bottomSection"
                            ...
                            <div class="relative h-[100%] pb-[20px] px-6 w-full ">
                                ...
                                <h2 id="modalTitle"
                                    class="overflow-hidden sm:overflow-visible line-clamp-1 sm:line-clamp-none text-stone-800 text-[20px] xl:text-[22px] font-trebuchet leading-[135%] -tracking-[0.03em] font-[500]">
                                    Proses pembuatan playmat test update tes judul yang panjaanang</h2>
                                <div class="flex items-end justify-start mt-[10px] h-6">
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[100px] ">Dibuat</span>
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[20px] ">
                                        : </span>
                                    <span id="modalDate"
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px]"></span>
                                </div>
                                <div class="flex items-end justify-start mt-[8px] h-6">
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[100px] ">Status</span>
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[20px] ">
                                        : </span>
                                    <label class="relative inline-flex items-center cursor-pointer h-6">
                                        ...
                                        <div
                                            class="w-11 h-6 bg-gray-300 peer-focus:ring-2 peer-focus:ring-blue-300 rounded-full peer peer-checked:bg-blue-600 after:content-[''] after:absolute after:top-1 after:left-1 after:bg-white after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:after:translate-x-5">
                                        </div>
                                    </label>
                                </div>
                                <div class="flex items-end justify-start mt-[20px] h-6">
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[100px] ">Deskripsi</span>
                                    <span
                                        class="text-stone-600 font-humanist-normal text-[16px] xl:text-[18px] w-[20px] ">
                                        : </span>
                                ...
                                <p id="modalDesc"
                                    class="h-auto max-h-[65%] sm:max-h-[70%] relative overflow-clip sm:overflow-auto line-clamp-3 sm:line-clamp-none text-stone-500 text-[16px] xl:text-[18px] font-humanist-normal leading-[130%] tracking-[0.02em] font-[400]">
                                </p>

                                <!-- Buttons -->
                                <div class="mt-[20px] flex gap-3 justify-end">
                                    <a href="" id="editBtn"
                                        class="bg-orange-400 text-white px-4 py-2 rounded-lg hover:bg-orange-600 cursor-pointer">
                                        Edit
                                    </a>
                                    <button id="deleteBtn"
        ...
        if (currentItem) {
            try {
                ...
                if (response.ok) {
                    ...
                    document.getElementById('status-' + currentItem.dataset.id).classList.remove(
                        'bg-red-400', 'bg-green-400');
                    if (currentItem.dataset.status == 1) {
                        document.getElementById('status-' + currentItem.dataset.id).classList.add(
                            'bg-green-400');
                    } else {
                        document.getElementById('status-' + currentItem.dataset.id).classList.add(
                            'bg-red-400');
