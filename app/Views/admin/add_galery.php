            ...
            <main class="p-6 flex-1 overflow-y-auto">
                <form id="upload-form" action="/admin/galery/store" method="POST">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div>
                                ...
                                <div class="mt-2 grid grid-cols-4 gap-5   px-6 py-6">
                                    <div
                                        class="relative text-center  col-span-3 rounded-lg border border-dashed border-gray-900/25">
                                        <h2 class="absolute top-2 left-2 text-base/7 font-semibold text-gray-900">
                                            Gambar/Video</h2>
                                        <svg id="image-icon" class="mx-auto size-12 text-gray-300" viewBox="0 0 24 24"
                                    ...
                                    <div
                                        class="relative flex justify-center items-center h-auto aspect-square w-full  col-span-1 rounded-lg border border-dashed border-gray-900/25">
                                        <h2 class="absolute top-2 left-2 text-base/7 font-semibold text-gray-900">
                                            Thumbnail</h2>
                    ...
                    <div id="action-button" class="mt-6 flex items-center justify-end gap-x-6">
                        <a href="javascript:history.back()" id="cancel-button" type="button"
            ...
            if (fileType.startsWith('image/')) {
                ...
                reader.onload = function(e) {
                    ...
                    img.onload = function() {
                        ...
                        document.getElementById('thumbnail-data').value = canvas.toDataURL(
                            'image/jpeg');
                        contentType.value = 0;
                    };
                ...
                videoPreview.addEventListener('seeked', function() {
                    if (videoPreview.videoWidth > 0 && videoPreview.videoHeight > 0) {
                        ...
                        ctx.drawImage(videoPreview, cropX, cropY, cropSize, cropSize, 0, 0, maxSize,
                            maxSize);
                        document.getElementById('thumbnail-data').value = canvas.toDataURL(
                            'image/jpeg');
                        contentType.value = 1;
