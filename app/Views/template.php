...
=======
    ...
    <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4" fetchpriority="high"></script>
    <!-- <link rel="stylesheet" href="output-v6.css" fetchpriority="high"> -->
            ...
            <div class="w-full max-w-[1600px] sm:mx-[25px]">
                <div class="relative flex h-16 items-center justify-between">
                    <div class="flex flex-1 items-center sm:items-stretch sm:justify-start">
                        <div class="flex shrink-0 items-center ml-[25px] sm:ml-0">
                            <img height="32px" width="62.5px" class="h-8 w-auto"
                                src="https://cdn.jsdelivr.net/gh/okakakikioAxe/kpn-storage/kpn-white-logo.png"
                                alt="Your Company" fetchpriority="high">
                        </div>
                        <div class="hidden md:ml-6 md:grid grid-cols-4 w-full ">
                            <div class="flex space-x-4 col-span-3">
                                <a href="/"
                            ...
                            <div class="flex w-full justify-end col-span-1 relative">
                                <button id="dropdownButton1"
                                    class="px-[23px] w-auto text-white rounded-full border-[1px] border-white  cursor-pointer">
                                    <div class="flex items-center">
                                        <p class="grow text-sm font-medium text-gray-300 selected-language">Bahasa
                                            Indonesia</p>
                                        <p class="w-[30px]">
                                            <svg id="dropdownIcon1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-[25px] md:hidden">
                        <button onclick="toggleMenu()" type="button"
                            ...
                            <svg id="open-menu-icon" class="block size-6" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                            </svg>
                            <svg id="close-menu-icon" class="hidden size-6" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor">
        ...
        <footer class="flex justify-center  bg-[#07172C]">
            <div class="bg-[#07172C] p-[24px] max-w-[1600px]">
                <img loading="lazy" height="56.3px" width="110px" class="w-[110px] h-auto"
                    src="https://cdn.jsdelivr.net/gh/okakakikioAxe/kpn-storage/kpn-white-logo.png"
                    alt="Logo KPN warna putih">

                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-[44px] mt-[46px]">
                    <p class="text-start text-white text-[18px] font-humanist-normal tracking-wide"
                        data-lang-group="footer" data-lang-key="description">PT Karya Pilar Nusantara adalah produsen
                        tangan pertama untuk produk HDPE, EVA, TPE, dan XPE di bidang mainan anak, olahraga, dan
                        infrastruktur. Kami menghadirkan produk berkualitas premium dengan harga terjangkau,
                        mengutamakan daya tahan, keamanan, dan inovasi untuk memenuhi kebutuhan pelanggan dengan solusi
                        terbaik.</p>
                    <div class="grid grid-cols-2">
                        <div class="grid grid-flow-col grid-rows-4 gap-[22px] sm:justify-center">
                            <h3 class="text-white text-[22px] font-trebuchet -tracking-[0.02em] font-[500]"
                                data-lang-group="footer" data-lang-key="company">Perusahaan</h3>
                            <a class="text-white text-[18px] font-trebuchet -tracking-[0.02em] font-extralight"
                                href="/about-us" data-lang-group="footer" data-lang-key="about">Tentang</a>
                            <a class="text-white text-[18px] font-trebuchet -tracking-[0.02em] font-extralight"
                                href="/product" data-lang-group="footer" data-lang-key="product">Produk</a>
                            <a class="text-white text-[18px] font-trebuchet -tracking-[0.02em] font-extralight"
                                href="/galeri" data-lang-group="footer" data-lang-key="gallery">Galeri</a>
                        </div>
                        <div class="grid grid-flow-col grid-rows-4 gap-[22px] sm:justify-center">
                            <h3 class="text-white text-[22px] font-trebuchet -tracking-[0.02em] font-[500]"
                                data-lang-group="footer" data-lang-key="contact_us">Hubungi Kami</h3>
                            <a class="text-white text-[18px] font-trebuchet -tracking-[0.02em] font-extralight"
                                href="/contact-us" data-lang-group="footer" data-lang-key="contact">Kontak</a>
                        </div>
                    </div>
                    <div class="hidden xl:block w-full h-[30px] ">
                        <div class="w-full h-auto flex  items-center">
                            <img loading="lazy" class="w-[37px] h-[37px] mr-[30px]" src="translate_icon.png"
                                alt="translate icon">
                            <div class="relative w-full">
                                ...
                                <button id="dropdownButton3"
                                    ...
                                    <div class="flex">
                                        <p class="grow text-[18px] font-trebuchet -tracking-[0.02em] selected-language">
                                            Bahasa Indonesia</p>
                                        <p class="w-[30px]">
...
=======
    <div id="waButton"
        class="scale-75 md:scale-80 lg:scale-90 xl:scale-100 bottom-3 md:bottom-5 lg:bottom-8 xl:bottom-10 right-3 md:right-5 lg:right-8 xl:right-10 fixed z-50 rounded-full h-20 w-20 bg-green-500 hover:scale-110 transform duration-300 cursor-pointer place-content-center">
        <a href="http://wa.me/6282160050005" target="_blank">
            <img width="100px" height="100px" loading="lazy" class="w-10 h-10 mx-auto"
                src="https://cdn.jsdelivr.net/gh/okakakikioAxe/kpn-storage/whatsapp-icon.webp" alt="whatsapp icon"
                fetchpriority="high">
        </a>
>>>>>>> b3e526899119848feddc0ba1691280352cade722
    </div>
...
=======
    <?= $this->renderSection('script') ?>
    <script defer type="text/javascript" src="/js/template-minified.js"></script>
    <script defer type="text/javascript" src="/js/translation-minified.js"></script>
>>>>>>> b3e526899119848feddc0ba1691280352cade722
